...
// Inline SVG icons (Lucide-style strokes plus brand marks) so we don't ship an icon library.
const paths = {
  github: (
    <path
      fill="currentColor"
  ...
  heart: <path d="M12 20s-7.5-4.6-9.2-9.3A5 5 0 0 1 12 6a5 5 0 0 1 9.2 4.7C19.5 15.4 12 20 12 20Z" />,
  star: <path d="m12 3 2.8 5.8 6.2.9-4.5 4.4 1 6.2L12 17.4l-5.5 2.9 1-6.2L3 9.7l6.2-.9L12 3Z" />,
  ...
  tool: <path d="M14.7 6.3a4 4 0 0 0 5 5L21 13l-8 8-4-4 8-8-1.3-1.3a4 4 0 0 1-5-5l2.6 2.6 2.1-.3.3-2.1-2.6-2.6Z" />,
  layout: (
    <>
  ...
  puzzle: <path d="M10 3h4v3a2 2 0 1 0 4 0h0V3h3v7h-3a2 2 0 1 0 0 4h3v7h-7v-3a2 2 0 1 0-4 0v3H3v-7h3a2 2 0 1 0 0-4H3V3h7Z" />,
